...
export interface Notification {
  id: string
  businessId: string
  /** "admin" notifications appear in the topbar/dashboard; "member"
   * notifications appear in the user portal for the matching memberId. */
  audience: NotificationAudience
  /** Optional — when audience = "member", the recipient's id. */
  memberId?: string
  /** Optional — when the notification was generated by an action against
   * a specific card / member / transaction, the relevant id. */
  cardId?: string
  ...
  title: string
  body: string
  /** Optional deep-link target rendered as a button in the dropdown / page. */
  href?: string
  /** Whether the user has marked this notification as read. */
  read: boolean
  /** ISO timestamp. */
  createdAt: string
  /** Optional ISO timestamp for when the user marked it read. */
  readAt?: string
}
...
export interface ActivityEntry {
  ...
  title: string
  body?: string
  /** Optional id of the related entity so the timeline can deep-link. */
  cardId?: string
  memberId?: string
  transactionId?: string
  operatorId?: string
